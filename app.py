...
<div class="main-header">
    ...
    <p>Tác giả: Đinh Quốc Hưng - Trường Tiểu học Vân Sơn - ĐT 0344 805 706</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đinh Quốc Hưng - Trường Tiểu học Vân Sơn - ĐT 0344 805 706</div>", unsafe_allow_html=True)
